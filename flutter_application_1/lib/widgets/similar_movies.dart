...
import 'package:flutter_application_1/bloc/get_movie_similar_bloc.dart';
import 'package:flutter_application_1/bloc/get_movies_bloc.dart';
     ...
     return  Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text("MOVIE Serupa ", style: TextStyle(
